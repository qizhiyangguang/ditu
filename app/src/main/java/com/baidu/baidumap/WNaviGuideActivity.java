...
// invoke virtual method 'android.view.View android.view.View.findViewById(int)' on
// a null object reference
//需要将AppCompatActivity改为Activity,否则报上面的错误
...
//获取诱导页面地图展示View
        ...
        //获取语音播报文本,不包含语音播报功能，需要自行传入对应的语音回调，
        // 形成播报功能。建议使用百度语音识别服务SDK。
